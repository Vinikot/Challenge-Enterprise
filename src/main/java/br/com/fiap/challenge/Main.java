...
public class Main {
    ...
    public static HttpServer startServer() {
        ...
        final ResourceConfig rc = new ResourceConfig()
                ...
                .packages("br.com.fiap.challenge.domain.resources", "br.com.fiap.challenge.infra.security.resources");
    ...
    public static void main(String[] args) {
        ...
        System.out.printf("App Procura Certa started with endpoints /available as %s%nHit Ctrl-C to stop it....%n", BASE_URI + "hello");
        try {
            System.in.read();
            server.stop();
        } catch (IOException e) {
